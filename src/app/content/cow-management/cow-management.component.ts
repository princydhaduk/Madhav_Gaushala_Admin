...
@Component({
  selector: 'app-cow-management',
  templateUrl: './cow-management.component.html',
  styleUrls: ['./cow-management.component.scss']
})
export class CowManagementComponent implements OnInit { 
